  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      full: {
        ...
        dest: 'dist/angular-modal.full.js'
      }
    },
    uglify: {
      options: {
      ...
      dist: {
        src: 'dist/angular-modal.js',
        dest: 'dist/angular-modal.min.js'
      },
      full: {
        src: 'dist/angular-modal.full.js',
        dest: 'dist/angular-modal.full.min.js'
      }
    },
    clean: {
      bower: [
